"""Information about a vehicle's real-time location and movement.

Fields from the GTFS VehiclePosition section include:
    Latitude: current latitude coordinate of the vehicle.
    Longitude: current longitude coordinate of the vehicle.
    Timestamp: the moment at which the vehicle's position was measured.
    Bearing: the bearing in degrees clockwise from North.
    Odometer: odometer value, when present.
